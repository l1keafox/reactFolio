    ...
    <header className="flex flex-col  py-8 gap-x-2 gap-y-1 text-center items-center justify-center font-mono">
      ...
      >
        <div className="w-4/5 mx-auto">
          <div className="flex justify-center items-center space-x-16 text-5xl font-ubuntu dark:text-slate-400">
            <p>
              I am a<span className="text-green-400"> full stack </span>software
              engineer with a background in{" "}
              <span className="text-red-600">malware</span> research. I enjoy
      ...
      >
        ...
        <div className="flex flex-wrap justify-center items-center">
          ...
          <Tooltip title="Github" arrow>
            <div>
              <SiGithub className={icon}></SiGithub>
            </div>
          </Tooltip>
